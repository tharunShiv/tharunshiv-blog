        ...
        <article className="post page" css={[PostFull, NoImage]}>
          ...
          <PostFullContent className="post-full-content">
            <div className="post-content">
              ...
              <p><b>My Written Articles on this blog & Dev.to:</b><br/>
                <a href="https://dev.to/developertharun">Dev.to - Developer Tharun</a></p>
              <p><b>My Video Content:</b><br/>
                <a href="https://www.youtube.com/c/developerTharun">Developer Tharun - YouTube</a></p>
              <p><b>My Courses:</b><br/>
                <a href="https://www.udemy.com/user/tharun-shiv/">Udemy - Tharun Shiv</a></p>
              <p><b>My Podcast ( audio content ):</b><br/>
                <a href="https://open.spotify.com/show/7shMt7zJDTTXxaQzadlgYy">Spotify - Developer Tharun Podcast</a></p>
              <p><b>Chat with me on Telegram:</b><br/>
                <a href="https://t.me/tharunshiv">Telegram - Tharun Shiv</a></p>
